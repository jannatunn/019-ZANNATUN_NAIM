...
<div class="min-h-full">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Alamat</a>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
  ...
  <main>
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
      <!-- Your content -->
      <h3>selamat datang di halaman contact</h3>
      <p>di sini akan di jelaskan tentang halaman contact, barang yang di jual beserta detailnya.</p>
